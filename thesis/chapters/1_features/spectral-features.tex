...
El \textit{spectral flatness} (SF)~\cite{Peters04,Fagerlund07,Zamanian17} de una señal refleja su similitud a una señal compuesta por ruido, caso en que su valor se aproxima a 1;
