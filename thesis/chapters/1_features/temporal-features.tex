...
El \textit{log-attack time} (LAT) de una señal se calcula entonces como el logaritmo en base 10 de la duración del intervalo de tiempo transcurrido entre los momentos en que la señal se hace audible ($stopAttack$) y en que alcanza su máxima intensidad ($startAttack$):
...
\subsubsection{Temporal Centroid}

El \textit{temporal centroid} (TC) de la señal es el punto donde se localiza el centro de gravedad de su AP\@.
