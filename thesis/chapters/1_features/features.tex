...
Cada trama de $N$ muestras es usualmente obtenida mediante la aplicación de una función \textit{ventana} $w(t)$ a la señal, que es distinta de cero solo si $1\leq t\leq N$.
Dada la señal $s(t)$, una trama que comienza en la muestra $m$ es obtenida como
...
La elección de la ventana $w(t)$ tiene un efecto sobre los resultados de operaciones posteriores sobre las tramas obtenidas.
