...
$\gamma(z_{ik})$ es conocida como la \textit{responsabilidad} de la componente $k$ sobre la observación $i$-ésima $x_i$.
...
La cantidad de iteraciones requeridas por EM para converger es mayor que las que toma K-Means. % TODO cite me!
